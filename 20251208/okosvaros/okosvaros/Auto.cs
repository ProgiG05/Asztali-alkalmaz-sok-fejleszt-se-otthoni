...
namespace okosvaros
{
    class Auto : Jarmu, IKornyezetBarat
    {
        ...
        public override string Kategoria { get; }
        ...
        {
            string jel = UzemanyagTipus == "benzin" || UzemanyagTipus == "dízel" ? "l" : "%";
            return $"Azonosító: {Azonosito}\nFőrhely: {Ferohely}\nSebesség: {Sebesseg}km/h\nÜzemenyagatípus: {UzemanyagTipus}\nKárosanyag-kibocsátása {KibocsatasSzintje()} g/km\nAktuális üzemanyagszintje {EnergiaSzint} {jel}";
        }
